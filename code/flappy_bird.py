...
if __name__ == "__main__":
    ...
    genetic.pop_list = genetic.init_pop()
    ...
    while True:
        ...
        # event loop
        handle_events(game, genetic, genetic.pop_list)

        # one generation is not over
        if game.game_active and game.game_start:
            genetic.run_GA()
            for bird in genetic.pop_list:
